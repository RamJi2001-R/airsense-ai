const About = () => {
  return (
    <div className="min-h-screen bg-gray-950 text-white px-8 py-10 flex flex-col items-center">
      ...
      {/* What is AirSense */}
      <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 mb-6 max-w-3xl text-center">
        <h2 className="text-2xl font-bold text-white mb-3">What is AirSense AI?</h2>
      ...
      {/* Problem We Solve */}
      <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 mb-6 max-w-3xl text-center">
        <h2 className="text-2xl font-bold text-white mb-3">🎯 Problem We Solve</h2>
        <p className="text-gray-300 leading-relaxed">
      ...
      {/* Tech Stack */}
      <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 mb-6 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 justify-items-center">
          {[
            ...
            <div key={item.label} className="bg-gray-800 rounded-xl p-4 text-center w-full">
              <p className="text-2xl mb-1">{item.icon}</p>
              <p className="text-green-400 font-semibold">{item.label}</p>
      ...
      {/* Features */}
      <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 max-w-3xl text-center mx-auto">
